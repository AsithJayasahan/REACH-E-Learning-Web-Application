...
<head>
    ...
    <title>Digital Literacy Training - Course Completion</title>
       <!-- Favicon -->
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="certificate-container">
                    ...
                    <p class="lead mb-4">Congratulations on completing the Digital Literacy Training course!</p>
        ...
        document.getElementById('generateCertificateBtn').addEventListener('click', async function() {
            ...
            try {
                ...
                const certificateData = {
                    name: userName,
                    course: "Digital Literacy Training ",
                ...
                a.href = url;
                a.download = `Digital Literacy Training_Certificate_${certificateData.certificateId}.pdf`;
