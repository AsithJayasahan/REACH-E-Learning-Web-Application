...
<head>
    ...
    <title>Fundamentals English Training - Course Completion</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="certificate-container">
                    ...
                    <p class="lead mb-4">Congratulations on completing the Fundamentals English Training  course!</p>
        ...
        document.getElementById('generateCertificateBtn').addEventListener('click', async function() {
            ...
            try {
                ...
                const certificateData = {
                    name: userName,
                    course: "Fundamantals English Training",
                ...
                a.href = url;
                a.download = `Fundamantals English Training_Certificate_${certificateData.certificateId}.pdf`;
